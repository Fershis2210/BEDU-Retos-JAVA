...
class Tema implements Comparable <Tema> {
    ...
    @Override
    public int compareTo (Tema otro) { return this.titulo.compareTo(otro.titulo); }
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Temas ordenados pro prioridad (1 = urgente)");
        for (Tema t : temas) {
            System.out.println(t);
        }
        ...
        System.out.println("Repositorios de recursos por tema: ");

...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            System.out.println("Ingresa el consumo de CPU en porcentaje (solo enteros). Escribe -1 para terminar.");
            ...
            while (true) {
                ...
                if (valor > 95) {
                    throw new ExcepcionConsumo("CUIDADO: Consuomo crítico detectado (" + valor + "%)");
                }
